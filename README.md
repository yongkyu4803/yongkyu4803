# 안녕하세요, yongkyu4803입니다 👋

**공공데이터를 더 쉽게 찾고 활용하는 AI 도구를 만듭니다.**

법안과 정부 발표 자료를 검색 가능한 도구로 연결하고, 한국어 문서와 개인정보를 다루는 실용적인 앱을 만들고 있습니다.

![문서, 정부 발표, 개인정보 보호, 개발 도구가 검색으로 연결되는 일러스트](assets/public-data-tools.png)
